<?php
    ...
    define('TITLE',"Find People | Expresspeer");
    ...
    <body style="background: #f1f1f1">
        ...
        <main role="main" class="container">
            <div class="mx-5">
                ...
                <div class="d-flex align-items-center p-3 my-3 mx-5 text-white-50 shadow p-3 mb-5 bg-white rounded">
                    <img class="mr-3" src="img/Expresspeer.png" alt="" width="48" height="48">
                  <div class="lh-100">
                    <h1 class="mb-0 text-blue lh-100">Expresspeer Users</h1>
                    <small>Spreading Ideas</small>
                  </div>
                </div>

                <div class="my-3 mx-5 p-3 bg-white rounded shadow-sm">
                  <h5 class="border-bottom border-gray pb-2 mb-0">Find People on Expresspeer</h5>
                  ...
                  <?php
                    ...
                    {
                        echo '<a href="includes/delete-user.inc.php?user='.$row['idUsers'].'" >
