<?php
    ...
    session_start();
    define('TITLE',"Contact Us | Expresspeer");
			...
			<div class="contact100-more flex-col-c-m" style="background-image: url('img/contact.jpg');">
				<div class="flex-w size1 p-b-47">
					...
					<div class="flex-col size2">
						...
						<span class="txt2">
                                                    A startup initiated by a group of Computing & Software Engineering undergraduate students<br>
				...
				<div class="dis-flex size1 p-b-47">
					...
					<div class="flex-col size2">
						...
						<span class="txt3">
                        <a href="mailto:contact.us.expresspeer@gmail.com">contact.us.expresspeer@gmail.com</a>
						</span>
					</div>
				</div>
                            <?php
