...
<?php
    ...
    define('TITLE',"Dashboard| Expresspeer");
...
?> 
    ...
    <body onload="pageLoad()">
        ...
        <img src='img/Expresspeer.png' id='loader-logo'>
            <div class="loader">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7" >
                        ...
                        <div class="text-center p-3">
                            <img src="img/Expresspeer.png" height="120px" width="120px">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="d-flex align-items-center p-3 my-3 text-white-50 shadow p-3 mb-5 bg-white rounded">
                                
                                    <img class="mr-3" src="img/Expresspeer.png" alt="" width="48" height="48">
                                  <div class="lh-100">
                                    <h1 class="mb-0 text-blue lh-100">Latest Forums</h1>
                                  </div>
                                </div>  
                            ...
                            <div class="d-flex align-items-center p-3 my-3 text-white-50 shadow p-3 mb-5 bg-white rounded">
                                    <img class="mr-3" src="img/Expresspeer.png" alt="" width="48" height="48">
                                  <div class="lh-100">
                                    <h1 class="mb-0 text-blue lh-100">Latest Blogs</h1>
                                  </div>
                                </div>  
                            ...
                            <div class="d-flex align-items-center p-3 my-3 text-white-50 shadow p-3 mb-5 bg-white rounded">
                                    <img class="mr-3" src="img/Expresspeer.png" alt="" width="48" height="48">
                                  <div class="lh-100">
                                    <h1 class="mb-0 text-blue lh-100">Latest Polls</h1>
                                  </div>
                                </div>  
                            ...
                            <div class="d-flex align-items-center p-3 my-3 text-white-50 shadow p-3 mb-5 bg-white rounded">
                                    <img class="mr-3" src="img/Expresspeer.png" alt="" width="48" height="48">
                                  <div class="lh-100">
                                    <h1 class="mb-0 text-blue lh-100">Upcoming Events</h1>
                                  </div>
                                </div>  
                                  ...
                                  <?php
                                    ...
                                    else
                                    {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result))
                                        {
                                            ...
                                            {
                                                echo '<a href="includes/delete-event.php?id='.$row['event_id'].'&page=index" >
                    ...
                    <div class="col-sm-2">
                        ...
                        <a href="forum.php" class="btn btn-warning btn-lg btn-block">Expresspeer Forum</a>
                        
                        <a href="hub.php" class="btn btn-secondary btn-lg btn-block">Expresspeer Hub</a>
                        <br><br><br>
